...
@dataclass
class ApplyMemFTHyperParams(HyperParams):
    # Model related
    alg_name: str = 'memft'
    ...
    def from_hparams(cls, hparams_name_or_path: str):
        ...
        assert (config and config['alg_name'] == 'memft') or print(f'ApplyMemFTHyperParams can not load from {hparams_name_or_path}, '
