...
class SFTHyperParams(HyperParams):
    ...
    target_only_loss: bool = False  # If True in inference, append target-only final-loss columns.
    target_only_debug: bool = False
    target_only_raw_target_field: str = "target"
